...
RSVP stands for two things Répondez S’il Vous Plaît and my initials Rafael Subía Valdez Presets. The concept of RSVP in an invitation, is to confirm assistance to an event and effectively reserving a place. This translated to the preset system is a space and time "reserved" for a certain value.
